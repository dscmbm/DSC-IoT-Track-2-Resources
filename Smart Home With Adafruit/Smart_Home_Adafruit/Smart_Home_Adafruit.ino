...
Adafruit_MQTT_Publish Suhu = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/Temp");          // feed for Temperature
...
void setup() {
  ...
  pinMode(Magnetpin, INPUT_PULLUP); // Magnet
  pinMode(DHTPIN, INPUT_PULLUP);     // DHT
  pinMode(Relay1, OUTPUT);          // Lamp 1
  pinMode(Relay2, OUTPUT);          // Lamp 2
